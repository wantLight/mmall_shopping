...
public class IOrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        stringMap.put("orderNo", String.valueOf(order.getOrderNo()));
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                stringMap.put("qrUrl", qrUrl);
                return ServerResponse.createBySuccess(stringMap);
            ...
            default:
                ...
                return ServerResponse.createByErrorMessage("交易返回异常");
        }
    }
    ...
    public ServerResponse<String> cancel(Integer userId,Long orderNo){
        ...
        if (order.getStatus() != Const.OrderStatusEnum.NO_PAY.getCode()){
            return ServerResponse.createByErrorMessage("已付款，无法取消哦");
        }
